...
| historia-3.3.md | Obtener usuario actual desde token                    | Completada  |
| historia-3.4.md | Protección y autorización en creación de artículos    | Completada  |
...
- Se creó la función get_current_user en app/core/security.py para obtener el usuario desde el token.
- La ruta POST /items/ ahora requiere autenticación y solo permite crear artículos al usuario admin.
